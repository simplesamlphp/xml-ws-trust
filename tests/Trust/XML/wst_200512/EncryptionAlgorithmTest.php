...
/**
 * Class \SimpleSAML\WebServices\Trust\XML\wst_200512\EncryptionAlgorithmTest
 *
...
final class EncryptionAlgorithmTest extends TestCase
{
    ...
    {
        $encryptionAlgorithm = EncryptionAlgorithm::fromString(C::NAMESPACE);

        $expectedXml = self::$xmlRepresentation->saveXml(self::$xmlRepresentation->documentElement);
        $this->assertNotFalse($expectedXml);
        $actualXml = strval($encryptionAlgorithm);
